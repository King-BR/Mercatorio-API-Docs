...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MercatorioApi.ProductsHoldings();
  });
  ...
  describe('ProductsHoldings', function() {
    it('should create an instance of ProductsHoldings', function() {
      // uncomment below and update the code to test ProductsHoldings
      //var instance = new MercatorioApi.ProductsHoldings();
      //expect(instance).to.be.a(MercatorioApi.ProductsHoldings);
    });
