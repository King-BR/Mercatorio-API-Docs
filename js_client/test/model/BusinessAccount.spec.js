...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.BusinessAccount();
  });
  ...
  describe('BusinessAccount', function() {
    it('should create an instance of BusinessAccount', function() {
      // uncomment below and update the code to test BusinessAccount
      //var instance = new mercatoriojs.BusinessAccount();
      //expect(instance).to.be.a(mercatoriojs.BusinessAccount);
    });
