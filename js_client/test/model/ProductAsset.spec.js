...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.ProductAsset();
  });
  ...
  describe('ProductAsset', function() {
    it('should create an instance of ProductAsset', function() {
      // uncomment below and update the code to test ProductAsset
      //var instance = new mercatoriojs.ProductAsset();
      //expect(instance).to.be.a(mercatoriojs.ProductAsset);
    });
