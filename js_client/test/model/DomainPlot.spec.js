...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.DomainPlot();
  });
  ...
  describe('DomainPlot', function() {
    it('should create an instance of DomainPlot', function() {
      // uncomment below and update the code to test DomainPlot
      //var instance = new mercatoriojs.DomainPlot();
      //expect(instance).to.be.a(mercatoriojs.DomainPlot);
    });
