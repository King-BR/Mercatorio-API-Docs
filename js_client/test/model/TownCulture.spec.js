...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.TownCulture();
  });
  ...
  describe('TownCulture', function() {
    it('should create an instance of TownCulture', function() {
      // uncomment below and update the code to test TownCulture
      //var instance = new mercatoriojs.TownCulture();
      //expect(instance).to.be.a(mercatoriojs.TownCulture);
    });
