...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatorio-js.InventoryAssets();
  });
  ...
  describe('InventoryAssets', function() {
    it('should create an instance of InventoryAssets', function() {
      // uncomment below and update the code to test InventoryAssets
      //var instance = new mercatorio-js.InventoryAssets();
      //expect(instance).to.be.a(mercatorio-js.InventoryAssets);
    });
