...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MercatorioApi.HouseholdSustenance();
  });
  ...
  describe('HouseholdSustenance', function() {
    it('should create an instance of HouseholdSustenance', function() {
      // uncomment below and update the code to test HouseholdSustenance
      //var instance = new MercatorioApi.HouseholdSustenance();
      //expect(instance).to.be.a(MercatorioApi.HouseholdSustenance);
    });
