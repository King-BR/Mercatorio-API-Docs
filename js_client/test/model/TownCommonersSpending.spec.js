...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.TownCommonersSpending();
  });
  ...
  describe('TownCommonersSpending', function() {
    it('should create an instance of TownCommonersSpending', function() {
      // uncomment below and update the code to test TownCommonersSpending
      //var instance = new mercatoriojs.TownCommonersSpending();
      //expect(instance).to.be.a(mercatoriojs.TownCommonersSpending);
    });
