...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.MapRegion();
  });
  ...
  describe('MapRegion', function() {
    it('should create an instance of MapRegion', function() {
      // uncomment below and update the code to test MapRegion
      //var instance = new mercatoriojs.MapRegion();
      //expect(instance).to.be.a(mercatoriojs.MapRegion);
    });
