...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.ProductPastFlow();
  });
  ...
  describe('ProductPastFlow', function() {
    it('should create an instance of ProductPastFlow', function() {
      // uncomment below and update the code to test ProductPastFlow
      //var instance = new mercatoriojs.ProductPastFlow();
      //expect(instance).to.be.a(mercatoriojs.ProductPastFlow);
    });
