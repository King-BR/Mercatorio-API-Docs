...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatorio-js.Holdings();
  });
  ...
  describe('Holdings', function() {
    it('should create an instance of Holdings', function() {
      // uncomment below and update the code to test Holdings
      //var instance = new mercatorio-js.Holdings();
      //expect(instance).to.be.a(mercatorio-js.Holdings);
    });
