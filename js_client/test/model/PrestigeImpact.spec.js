...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mercatoriojs.PrestigeImpact();
  });
  ...
  describe('PrestigeImpact', function() {
    it('should create an instance of PrestigeImpact', function() {
      // uncomment below and update the code to test PrestigeImpact
      //var instance = new mercatoriojs.PrestigeImpact();
      //expect(instance).to.be.a(mercatoriojs.PrestigeImpact);
    });
