...
```javascript
import MercatorioApi from 'mercatorio_api';
let defaultClient = MercatorioApi.ApiClient.instance;
...
let apiInstance = new MercatorioApi.DefaultApi();
