...
/**
 * The ProductPastFlow model module.
 * @module model/ProductPastFlow
 * @version 1.0.0
 */
class ProductPastFlow {
    /**
     * Constructs a new <code>ProductPastFlow</code>.
     * @alias module:model/ProductPastFlow
     */
    constructor() { 
        
        ProductPastFlow.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductPastFlow</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductPastFlow} obj Optional instance to populate.
     * @return {module:model/ProductPastFlow} The populated <code>ProductPastFlow</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductPastFlow();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductPastFlow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductPastFlow</code>.
     */
 ...
 */
ProductPastFlow.prototype['production'] = undefined;

/**
 * @member {String} production_cost
 */
ProductPastFlow.prototype['production_cost'] = undefined;

/**
 * @member {String} consumption
 */
ProductPastFlow.prototype['consumption'] = undefined;

/**
 * @member {String} consumption_cost
 */
ProductPastFlow.prototype['consumption_cost'] = undefined;

/**
 * The quantity of the product imported via trade routes.
 * @member {String} import
 */
ProductPastFlow.prototype['import'] = undefined;

/**
 * @member {String} import_cost
 */
ProductPastFlow.prototype['import_cost'] = undefined;

/**
 * The quantity of the product exported via trade routes.
 * @member {String} export
 */
ProductPastFlow.prototype['export'] = undefined;

/**
 * @member {String} export_value
 */
ProductPastFlow.prototype['export_value'] = undefined;

/**
 * @member {String} export_cost
 */
ProductPastFlow.prototype['export_cost'] = undefined;

/**
 * The quantity of the product imported via contracts.
 * @member {String} inbound
 */
ProductPastFlow.prototype['inbound'] = undefined;

/**
 * @member {String} inbound_cost
 */
ProductPastFlow.prototype['inbound_cost'] = undefined;

/**
 * The quantity of the product exported via contracts.
 * @member {String} outbound
 */
ProductPastFlow.prototype['outbound'] = undefined;

/**
 * @member {String} outbound_value
 */
ProductPastFlow.prototype['outbound_value'] = undefined;

/**
 * @member {String} outbound_cost
 */
ProductPastFlow.prototype['outbound_cost'] = undefined;
...
export default ProductPastFlow;
