...
public class ApiClient {
    ...
    protected String basePath = "https://play.mercatorio.io/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://play.mercatorio.io/api",
      "Base API URL",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://play.mercatorio.io/api)
